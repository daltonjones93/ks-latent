...
Bandedness (Fiedler-seriated): **0.8090**
**p-value vs. 1000 random permutations: 0.9070**
Verdict: NOT significant (dense/unstructured coupling)
Discovered ordering (Fiedler permutation): `[9, 10, 7, 12, 14, 13, 11, 3, 0, 2, 4, 6, 15, 5, 1, 8]`
...
| propagator step-Jacobian spectral norm | 0.9451 | 0.9654 |
