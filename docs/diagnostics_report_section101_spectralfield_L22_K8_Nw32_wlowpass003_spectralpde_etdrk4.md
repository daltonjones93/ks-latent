...
**p-value vs. 1000 random permutations: 0.9870**
Verdict: NOT significant (dense/unstructured coupling)
Discovered ordering (Fiedler permutation): `[8, 2, 5, 10, 13, 0, 6, 7, 14, 15, 1, 3, 4, 9, 11, 12]`
...
| propagator step-Jacobian spectral norm | 1.0000 | 1.0000 |
