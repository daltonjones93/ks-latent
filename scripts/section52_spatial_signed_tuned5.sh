#!/bin/zsh
# User-directed 2026-09-01, "Section 52": identical to Sections 50/51
...
# Stage 2 300ep), but w_spatial (signed)=0.01 (up from 0.008).
set -e
cd /Users/daltonjones/Documents/latent_DA

TAG=section52_mlpmarkovian_wvar002_wspatialsigned01_logdet0035_200ep

echo "=== [1/3] Stage 1: mlp/markovian aux, w_decorr=0, w_var=0.02, w_spatial=0.01 (SIGNED), w_var_floor=0, w_logdet=0.0035, NO delta_cap, --amp, 200 epochs ==="
