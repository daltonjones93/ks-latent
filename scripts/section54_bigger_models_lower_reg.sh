#!/bin/zsh
# User-directed 2026-09-02, "Section 54": same larger models as Section 53
# (ViT AE d_model=108 ~1.24x, mlp/markovian aux hidden=141/n_blocks=3
...
# k_max=12, Stage 1 200ep/Stage 2 300ep) EXCEPT w_var reduced 0.02 ->
# 0.0015 and w_logdet reduced 0.0035 -> 0.000325.
set -e
cd /Users/daltonjones/Documents/latent_DA

TAG=section54_mlpmarkovian_bigger12x_dmodel108_wvar00015_wspatialsigned01_logdet0000325_200ep

echo "=== [1/3] Stage 1: ViT AE (d_model=108, ~1.24x) + mlp/markovian aux (hidden=141/n_blocks=3, 1.2x), w_decorr=0, w_var=0.0015, w_spatial=0.01 (SIGNED), w_var_floor=0, w_logdet=0.000325, NO delta_cap, --amp, 200 epochs ==="
mamba run -n da_env python scripts/train_stage1_patched.py \
  ...
  --w-decorr 0 --w-var 0.0015 --w-spatial 0.01 --spatial-signed --w-var-floor 0 --w-logdet 0.000325 \
  --full-propagator --amp \
