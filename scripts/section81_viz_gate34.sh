#!/bin/zsh
# User-directed 2026-09-04: "run visualizations and gate 3 / 4 analysis
# for 81 and then start 82 on mps in parallel" -- Section 81
# (ViT+FourierIFFTBody hybrid encoder/decoder, Section 75's exact
# propagator/regularizers, val_kmax_mse tracking notably better than
# Section 75 at the same curriculum point during training).
set -e
...
echo "=== Section 81 visualization + GIF + Gate 3/4 complete ==="
