#!/bin/zsh
# User-directed 2026-09-04: "run visualizations and diagnostics for
# section 86 when it completes automatically" -- Section 86 (= Section 52
# with w_spatial x1.3 and w_smooth=0.001 added). Same pattern as
...
echo "=== Section 86 visualization + GIF + Gate 3/4 complete ==="
